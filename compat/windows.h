...
// control styles (dialog templates; the GUI's controls read them)
enum {
	BS_CHECKBOX = 2, BS_RADIOBUTTON = 4, BS_3STATE = 5, BS_AUTO3STATE = 6, BS_GROUPBOX = 7, BS_AUTORADIOBUTTON = 9,
	BS_OWNERDRAW = 0xB, SS_CENTER = 1, SS_RIGHT = 2, SS_BLACKRECT = 4, SS_GRAYRECT = 5, SS_WHITERECT = 6,
	SS_BLACKFRAME = 7, SS_GRAYFRAME = 8, SS_WHITEFRAME = 9, SS_SIMPLE = 0xB, SS_LEFTNOWORDWRAP = 0xC, SS_OWNERDRAW = 0xD,
	SS_CENTERIMAGE = 0x200, ES_CENTER = 1, ES_RIGHT = 2, ES_PASSWORD = 0x20, CBS_DROPDOWN = 2, CBS_SORT = 0x100,
	LBS_SORT = 2, LBS_MULTIPLESEL = 8, LBS_USETABSTOPS = 0x80, LBS_EXTENDEDSEL = 0x800,
};
